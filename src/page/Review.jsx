  ...
  return (
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 p-6 gap-8">
      <div className="relative z-10 max-w-5xl mx-auto px-2">
        <h1 className="text-5xl text-white flex flex-col items-center justify-center md:text-5xl font-extrabold mb-4 animate-fade-in">
      ...
      <div className="bg-white/20 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/30 p-10 max-w-3xl w-full">
        ...
        {/* Show login warning if no token */}
        {!token && (
